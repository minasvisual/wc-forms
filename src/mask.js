// DOCS: https://github.com/vanilla-masker/vanilla-masker/tree/master
var DIGIT = "9",
    ALPHA = "A",
    ALPHANUM = "S",
  ...
  VMasker.toMoney = function(value, opts) {
    ...
    if(
      typeof value === 'string' && typeof opts.lastOutput === 'string' &&  
      (value.length - opts.lastOutput.length) === -1
    ) { 
      let rawValue = value.replace(/[\D]/g, "") 
      value = `${rawValue.slice(0, -2)}${opts.delimiter}${rawValue.slice(-2)}`
    }
